        ...
        else
        {
            ...
            case 'p':
                ...
                else if(atof(args[2]) > 0)
                {
                    ...
                    longRequest = malloc(sizeof(struct lRequest));
                    longRequest->type = 2;
                    longRequest->idArtigo = atoi(args[1]);
                    longRequest->preco = atof(args[2]);

                    write(ma_server, longRequest, sizeof(longRequest));
                }
                else
                {
                    write(1,"Insira um preço válido, por favor!\n",38);
            ...
            case 'a':
                ...
                longRequest = malloc(sizeof(struct lRequest));
                longRequest->type = 3;
                write(ma_server, longRequest, sizeof(struct lRequest));
